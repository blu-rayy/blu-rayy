...
-->
[![My Skills](https://skillicons.dev/icons?i=py,java,cpp,php,kotlin,supabase,sqlite,matlab,androidstudio,html,css,js,tailwind,nodejs,ts,vscode,figma,pr,ps,ae,ai)](https://skillicons.dev)
